...
// Release history
// 1.0c August 13, 2004
//      - replace "warning" by "debug" for POV 3.6 compatibility
//
// 1.0b April 10, 1999
//      - bug fixes (leaves with stalks weren't properly centered at <0,0,0> in the files)
//
// 1.0a April 1, 1999
...
#while (i<nseg)
        ...
        //-----------------------------------------
        //#debug concat("x",str(posb[i+1].x,0,3)," y ",str(posb[i+1].y,0,3)," z ",str(posb[i+1].z,0,3),">\n")
        #if(dofile = true)
...
//        #debug concat("i=",str(i,0,0)," x=",str(posb[i+1].x,0,3)," y=",str(posb[i+1].y,0,3)," z=",str(posb[i+1].z,0,3),"\n")

        //-----------------------------------------
        // a cone and a sphere : this is where the root is created
        //-----------------------------------------

//        #debug concat("rbseg1 ",str(vlength(posb[i]),0,3)," rbseg2 ",str(vlength(posb[i]),0,3),"\n")
        #if (dofile = true)
