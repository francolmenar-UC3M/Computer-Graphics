...
sphere { <0,0,0>, 0.5 
        ...
        texture { pigment{ color rgb<00, 1, 0.00>}
                  finish { phong 1.0 reflection 0.00}
                } // end of texture

          scale<0.5,0.5,0.5>  rotate<0,0,0>  translate<0,0.25,0>  
       }  // end of sphere -----------------------------------       
...
sphere { <0,0,2>, 0.5 
        ...
        texture { pigment{ color rgb<1, 0, 0.00>}
                  finish { phong 1.0 reflection 0.00}
                } // end of texture
...
sphere { <1.5,0,0.5>, 0.5 
        ...
        texture { pigment{ color rgb<00, 0, 1>}
                  finish { phong 1.0 reflection 0.00}
                } // end of texture
